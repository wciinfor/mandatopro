...
export default function NovoDoador() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/financeiro/parceiros', {
        method: 'POST',
        headers: {
      ...
      if (!response.ok) {
        throw new Error(data?.message || 'Erro ao criar doador');
      }

      showSuccess('Doador criado com sucesso!');
    ...
    <Layout titulo="Novo Doador">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Cadastro de Doador/Parceiro</h3>
        </div>
