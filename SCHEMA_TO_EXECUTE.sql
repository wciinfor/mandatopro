...
-- CORRIGIDO: Ordem de tabelas respeita dependências de chaves estrangeiras

-- ============================================================
-- 1. TABELA DE LIDERANÇAS (BASE - sem FK)
-- ============================================================
...
-- ============================================================
-- 2. TABELA DE ÓRGÃOS (BASE - sem FK)
-- ============================================================
...
-- ============================================================
-- 3. TABELA DE USUÁRIOS DO SISTEMA (refs liderancas)
-- ============================================================
...
-- ============================================================
-- 4. TABELA DE FUNCIONÁRIOS (BASE - sem FK para outros)
-- ============================================================
...
-- ============================================================
-- 5. TABELA DE ELEITORES (refs liderancas)
-- ============================================================
...
-- ============================================================
-- 6. TABELA DE ATENDIMENTOS (refs eleitores, usuarios)
-- ============================================================
...
-- ============================================================
-- 7. TABELA DE AGENDA/EVENTOS (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 8. TABELA DE SOLICITAÇÕES (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 9. TABELA DE DOCUMENTOS (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 10. TABELA DE EMENDAS PARLAMENTARES (refs usuarios, orgaos)
-- ============================================================
...
-- ============================================================
-- 11. TABELA DE REPASSES (refs emendas, usuarios)
-- ============================================================
...
-- ============================================================
-- 12. TABELA DE RESPONSÁVEIS POR EMENDAS (refs emendas, usuarios)
-- ============================================================
...
-- ============================================================
-- 13. TABELA DE GEOLOCALIZAÇÃO (MAPA) - após todas base serem criadas
-- ============================================================
...
-- ============================================================
-- 15. TABELA DE FINANCEIRO - DESPESAS (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 16. TABELA DE FINANCEIRO - LANÇAMENTOS (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 17. TABELA DE FINANCEIRO - DOADORES
-- ============================================================
...
-- ============================================================
-- 18. TABELA DE FINANCEIRO - FATURAS
-- ============================================================
...
-- ============================================================
-- 19. TABELA DE COMUNICAÇÃO - MENSAGENS (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 20. TABELA DE COMUNICAÇÃO - CONVERSAS (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 21. TABELA DE COMUNICAÇÃO - DISPARO EM MASSA (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 22. TABELA DE ANIVERSARIANTES (refs eleitores)
-- ============================================================
...
-- ============================================================
-- 23. TABELA DE LOGS DE AUDITORIA (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 24. TABELA DE ACESSOS AO SISTEMA (refs usuarios)
-- ============================================================
...
-- ============================================================
-- 25. TABELA DE CONFIGURAÇÕES DO SISTEMA
-- ============================================================
